...
const ClothingSlide = ({title, background, children}: ClothingProps) => {
    return(
        <div className="group relative h-screen w-1/3">
            <div className={`relative ${background} group-hover:ease-in-out duration-300 top-[0px] bg-cover bg-blend-overlay bg-stone-600 h-full w-full max-w-full group-hover:top-[-120px]`}/>
